...
$script:BuiltinProviders = @{
    ...
    minimax  = @{ Name = "MiniMax"; BaseUrl = "https://api.minimaxi.com/anthropic"; ModelMapping = @{...} }
    moonshot = @{ Name = "Kimi (Moonshot)"; BaseUrl = "https://api.moonshot.cn/anthropic"; ModelMapping = @{...} }
...
| `Get-MaskedApiKey` | API Key 脱敏（保留首尾各 4 字符） |
