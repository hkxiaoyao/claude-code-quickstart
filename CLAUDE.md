...
Windows 10/11 平台的 **Claude Code 开发环境自动化安装器**。双阶段 PowerShell 架构，PS 5.1 引导 + PS 7 主安装/更新，13 步依赖链，实时检测机制。
...
│   ├── core/                     # 8 个基础功能库（Ui/Process/Profile/Admin/Net/Registry/Bootstrap/McpManager）
...
graph TD
    ...
    C --> C4[Admin.ps1] & C5[Net.ps1] & C6[Registry.ps1] & C7[Bootstrap.ps1] & C8[McpManager.ps1]
...
| 模块 | 详细文档 | 职责 |
|------|---------|------|
| installer/ | [installer/CLAUDE.md](installer/CLAUDE.md) | 三入口脚本（安装/管理/更新）、步骤注册表 |
| installer/core/ | [installer/core/CLAUDE.md](installer/core/CLAUDE.md) | 8 个核心基础库（含 Registry + McpManager） |
